...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        let table = Table::create()
            ...
            .col(ColumnDef::new(SysAttributeValues::Weight).integer().not_null().default(0))
            ...
            .col(ColumnDef::new(SysAttributeValues::IsDefault).char().not_null())
            .col(ColumnDef::new(SysAttributeValues::Status).char().not_null())
