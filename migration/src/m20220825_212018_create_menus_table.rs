...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        let table = Table::create()
            ...
            .col(ColumnDef::new(Menus::Pid).big_integer().not_null().default(0))
            ...
            .col(big_integer(Menus::P1).default(0))
            .col(big_integer(Menus::P2).default(0))
            .col(big_integer(Menus::P3).default(0))
            .col(big_integer(Menus::P4).default(0))
            .col(big_integer(Menus::P5).default(0))
            .col(big_integer(Menus::P6).default(0))
            .col(big_integer(Menus::P7).default(0))
            .col(big_integer(Menus::P8).default(0))
