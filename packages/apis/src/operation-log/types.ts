...
export interface DescribeOperationLogDetailResponseData extends BaseResponse {
...
export interface DescribeCreateOperationLogResponseData extends BaseResponse {
  _name?: string;
}
