        ...
        {CATEGORIES?.slice(1)?.map((item) => {
          return (
            <a href={item?.href} key={item?.vid}>
              <button className='dark:hover:text-[var(--primary)] hover:text-[var(--primary)] active:bg-[var(--btn-plain-bg-active)] bg-none hover:bg-[var(--btn-plain-bg-hover)] rounded-lg dark:text-neutral-300 h-10 hover:pl-3 pl-2 text-neutral-700 transition-all w-full cursor-pointer'>
