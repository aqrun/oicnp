export const Weather1 = () => {
  return (
    <div className='max-w-xs1 overflow-hidden rounded-lg hover:shadow-md border border-slate-200 text-slate-800'>
      <div
        className='flex items-end justify-end h-32 p-4 bg-gray-500 bg-center bg-cover'
        style={{
          backgroundImage: 'url(https://source.unsplash.com/300x150/?skyline)',
        }}
      >
      ...
      <div className='flex items-center justify-between gap-8 p-4 border-t text-slate-600 border-gray-200'>
