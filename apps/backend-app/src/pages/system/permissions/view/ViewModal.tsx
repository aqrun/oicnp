...
import type { PermissionModel, DescribePermissionDetailRequestParams } from '@repo/apis';
...
export default function ViewModal() {
  ...
  const fetchInitialData = useMemoizedFn(async () => {
    ...
    const res = await permissionApis.DescribePermissionDetail(params);
    const parentRes = await permissionApis.DescribePermissionDetail({
