...
import type { DepartmentModel, DescribeDeleteDepartmentRequestParams } from '@repo/apis';
...
export default function TableActions({
  ...
  const deleteRole = useMemoizedFn(async () => {
    ...
    const params: DescribeDeleteDepartmentRequestParams = {
      id: record?.id,
    };
    // 删除
    const res = await departmentApis.DescribeDeleteDepartment(params);
