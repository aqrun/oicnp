...
import {   DescribeNodeDetailRequestParams, DescribeUpdateNodeRequestParams, NodeFieldType } from "@repo/apis";
import { useFetchNodeAll, useFetchCategoryList } from "#src/hooks/apis";
...
export default function EditModal() {
  ...
  const handleOk = useMemoizedFn(async () => {
    ...
    try {
      ...
      const res = await nodeApis.DescribeUpdateNode(params);
