...
import {   CategoryModel, DescribeCategoryDetailRequestParams, DescribeUpdateCategoryRequestParams } from "@repo/apis";
...
export default function EditModal() {
  ...
  const handleOk = useMemoizedFn(async () => {
    ...
    try {
      ...
      const res = await categoryApis.DescribeUpdateCategory(params);
