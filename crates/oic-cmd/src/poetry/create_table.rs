    ...
    manager
        .create_table(
            Table::create()
                ...
                .col(small_integer(Poetry::AuthorId).default(0))
                .col(string_len(Poetry::Dynasty, 20).default(""))
                .col(small_integer(Poetry::Weight).default(0))
                ...
                .col(date_time(Poetry::UpdatedAt).default(Expr::current_timestamp()))
                .to_owned(),
        )
        .await
    ...
    manager
        .create_table(
            Table::create()
                ...
                .col(date_time(PoetryLines::UpdatedAt).default(Expr::current_timestamp()))
                .to_owned(),
        )
        .await
    ...
    manager
        .create_table(
            Table::create()
                ...
                .col(date_time(Chapters::UpdatedAt).default(Expr::current_timestamp()))
                .to_owned(),
        )
        .await
    ...
    manager
        .create_table(
            Table::create()
                ...
                .col(date_time(ChapterLines::UpdatedAt).default(Expr::current_timestamp()))
                .to_owned(),
        )
        .await
